...
import { Plan } from 'src/app/modules/account/models/plan.model';
...
export class PlansComponent implements OnInit{
  ...
  days: Day[] = [];
  // to identify which container is which when dragging and dropping 
  // Material uses an array of ids to identify and establish a connection between 
  // all cdkDropList containers. with cdkDropListConnectedTo property set to [cdkDropListConnectedTo]="daysIDs"
  // and id="{{day.dayId}}"
  daysIDs: string[] = [];
